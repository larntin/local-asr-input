...
<p align="center">
  <img src="docs/images/popup-recording.png" width="640" alt="录音中"><br>
  <img src="docs/images/popup-editing.png" width="640" alt="识别完成，可以编辑后上屏">
</p>

> English: Free, open-source, local-first voice input for Windows. Press a hotkey, speak, get text transcribed on your own GPU/CPU by faster-whisper, fix it in a small popup, and paste it into whatever window you were in. Optional LLM clean-up via any OpenAI- or Anthropic-compatible API.
...
<p align="center">
  <img src="docs/images/settings-llm.png" width="420" alt="LLM 设置">
  <img src="docs/images/settings-general.png" width="420" alt="常规设置">
</p>
